export const conditionSurveyReport = {
  ...
  findings: [
    { item: "Main LV switchboard approaching end of serviceable life", priority: "High", budget: "£75k-£150k" },
    { item: "Limited spare capacity on selected distribution boards", priority: "Medium", budget: "£15k-£40k" },
    { item: "Distribution-board labelling incomplete", priority: "Medium", budget: "£5k-£15k" },
    { item: "Emergency-lighting records unavailable", priority: "Medium", budget: "£10k-£25k" },
